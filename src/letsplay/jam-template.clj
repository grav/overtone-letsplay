...
(definst noise1 [vol 1]  (* vol (quickfree "ding" 1 2)))
(definst noise2 [vol 1]  (* vol (quickfree "ding" 2 1.5)))
(definst noise3 [vol 1]  (* vol (quickfree "ding" 3)))
(definst noise4 [vol 1]  (* vol (quickfree "ding" 7 1)))
